 ...
 * {string} mode 'stack', 'stacktrace', 'multiline', 'callers', 'onerror', or 'failed' -- method used to collect the stack trace.
 */
...
/** JSDocs */
export function _computeStackTrace(ex: any): StackTrace {
...
function _computeStackTraceFromStackProp(ex: any): StackTrace | null {
...
/** JSDocs */
function _computeStackTraceFromStacktraceProp(ex: any): StackTrace | null {
  if (!ex || !ex.stacktrace) {
    return null;
  }
